...
{
    PlaySound(TEXT("SOUND FILES/marioDieSound.wav"),NULL,SND_SYNC);  
	pthread_exit(NULL); 
}
...
{
    PlaySound(TEXT("SOUND FILES/footSound.wav"),NULL,SND_SYNC);  
	pthread_exit(NULL); 
}
...
{
    PlaySound(TEXT("SOUND FILES/jumpSound.wav"),NULL,SND_SYNC);  
	pthread_exit(NULL); 
}
...
void startPage(){
	...
	PlaySound(TEXT("SOUND FILES/startSound.wav"),NULL,SND_SYNC); 
...
void lastPageScore(int boyCounter){
	...
	PlaySound(TEXT("SOUND FILES/gameOverSound.wav"),NULL,SND_SYNC);  
